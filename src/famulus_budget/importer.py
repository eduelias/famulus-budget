...
EXP_RULES = [
 ...
 ('Car & transport', r'ATHLON|Shell|Q-Park|CJIB|Dancar|PARK MOBILE|Kwik-Fit|parkeer|Parkeer|TinQ|Esso|BP\b|OV-\s?Chipka|TLS BV|NS GROEP|GVB|Viggo'),
 ...
 ('Entertainment & eating out', r"McDonalds|KFC|IJssalon|Kinepolis|Burger|Thuisbezorgd|Subway|Starbucks|La Place|Febo|Snackbar|MOJO|Arena 81|Pathe|UBER \*EATS|Costes|Chillie|Beach Club|Pizzeria|Trattoria|Butcher Social|Albron|NEMO|Center Parcs|Restaurant|NYX\*|Kiddy|Grill|Sushi|Pannenkoeken"),
